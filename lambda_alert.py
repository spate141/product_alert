...
logger = logging.getLogger('lambda_product_alert')
...
class ProductAlert:
    ...
    def check_product_lambda(self, product_object: dict):
        """
        ...
        if look_for_flag:
            ...
            logger.info(f'Product not available at: {website}')
